"""Small pre-class check for either supported student environment."""
...
def main():
    ...
    workbook = openpyxl.load_workbook(
        root / "setup_assets/workbook_probe.xlsx", read_only=True, data_only=True,
    )
    try:
        assert workbook.sheetnames == ["EnvironmentCheck"]
        assert workbook["EnvironmentCheck"]["B4"].value == "Workbook access is working."
    finally:
        workbook.close()
    ...
    print("Numerical libraries, chemistry, workbook access and plotting: OK")
